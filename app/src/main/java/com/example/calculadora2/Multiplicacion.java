...
public class Multiplicacion extends AppCompatActivity {
    ...
    TextView resultado;
    Button multiplicacionsita, regresar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        multiplicacionsita = findViewById(R.id.multiplicacionsita);
        regresar = findViewById(R.id.regresar);

        multiplicacionsita.setOnClickListener(new View.OnClickListener() {
            @Override
